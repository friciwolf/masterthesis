...
\Subsection{Training and Loss Optimization}
...
In order to further improve the optimization, the updates are evaluated for a fixed number of samples (batches). The main advantage of stochastic gradient descent is the consequtive updates towards a more general optimum and avoiding getting stuck at local optima due to strongly varying gradients evaluated from the dataset.
...
\begin{figure}
%	\centering
%	\includegraphics[width=0.4\linewidth]{figures/neural_networks/SN.pdf}
