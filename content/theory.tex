...
The first term describes the interaction of the gauge bosons among each other; the second term encodes the interaction between fermions altogether. The third term contains the Yukawa-couplings of the fermions to the Higgs field. The final and fourth term describes the interplay between the Higgs and the gauge bosons and the Higgs field itself through the potential $V(\phi)$
...
Despite its incredible predictivity (electron g-2), it is known that the Standard Model is an incomplete description of Nature. For this reason, several SM testing and BSM measurements are performed.
